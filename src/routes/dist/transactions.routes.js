...
transactionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, value, type, category, createTransactionService, transaction;
...
transactionsRouter["delete"]('/:id', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleteTransactionService;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                deleteTransactionService = new DeleteTransactionService_1["default"]();
                return [4 /*yield*/, deleteTransactionService.execute({ id: id })];
            case 1:
                _a.sent();
