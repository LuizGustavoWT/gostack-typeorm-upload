...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, Promise, function () {
            var transactionRepository, categoryRepository, transactionCategory, balance, transaction;
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        if (balance.total < value && type === 'outcome') {
                            throw new AppError_1["default"]('Você Não tem saldo para esta operração', 400);
                        }
